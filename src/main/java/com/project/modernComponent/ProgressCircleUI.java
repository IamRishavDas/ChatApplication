...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro){
        this.pro = pro;
        imageDownload = new ImageIcon(getClass().getResource("/uiIcons/downloadChatImage.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/uiIcons/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/uiIcons/fileImage.png")).getImage();
    }
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        if(pro.getProgressType() != Progress.ProgressType.NONE){
            g2.drawImage(pro.getProgressType() == Progress.ProgressType.CANCEL_FILE ? this.imageCancel : (pro.getProgressType() == Progress.ProgressType.DOWNLOAD_FILE ? this.imageDownload : this.imageFile),
