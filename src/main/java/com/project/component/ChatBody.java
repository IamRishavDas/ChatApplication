...
public class ChatBody extends javax.swing.JPanel {
    ...
    public ChatBody() {
        ...
        init();
        addItemRight(
                "Practical task: For example, you might be asked to create a webpage that displays a greeting message which changes based on the time of the day. Use HTML, CSS, and a bit of JavaScript.");
        addItemLeft(
                "Practical task: For example, you might be asked to create a webpage that displays a greeting message which changes based on the time of the day. Use HTML, CSS, and a bit of JavaScript.",
                "rishav");
        addItemRight(
        ...
        addItemLeft(
                "Practical task: For example, you might be asked to create a webpage that displays a greeting message which changes based on the time of the day. Use HTML, CSS, and a bit of JavaScript.",
                "rishav", new ImageIcon(getClass().getResource("/testingImages/testingDog.jpg")),
                new ImageIcon(getClass().getResource("/testingImages/testingDog.jpg")));
        addItemRight(
                "Practical task: For example, you might be asked to create a webpage that displays a greeting message which changes based on the time of the day. Use HTML, CSS, and a bit of JavaScript.");
        ...
        addItemLeft(
                "Practical task: For example, you might be asked to create a webpage that displays a greeting message which changes based on the time of the day. Use HTML, CSS, and a bit of JavaScript.",
                "rishav", new ImageIcon(getClass().getResource("/testingImages/testingDog.jpg")));
        addItemRight("Practical task", new ImageIcon(getClass().getResource("/testingImages/testingImage2.jpg")),
                new ImageIcon(getClass().getResource("/testingImages/testingDog.jpg")));
        addItemLeft("", "hitesh", new ImageIcon(getClass().getResource("/testingImages/testingDog.jpg")));
        addItemLeft("", "Prem", new ImageIcon(getClass().getResource("/testingImages/testingDog.jpg")));
